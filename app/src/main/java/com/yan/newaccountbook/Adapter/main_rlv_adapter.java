...
public class main_rlv_adapter extends RecyclerView.Adapter<main_rlv_adapter.ViewHolder> {
    public interface OnClickListener{
        void OnDelAccount(AccountBean accountBean);
    }
    ...
    public main_rlv_adapter(Context context, List<AccountBean> accountBeanList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.relativeLayout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                 ...
                 * 通过接口回调，实现事件响应
                 */
                onClickListener.OnDelAccount(accountBean);
                return false;
            }
        });
    }
